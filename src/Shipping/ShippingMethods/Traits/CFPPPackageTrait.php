...
/**
*   Wrapper for the WC_Correios_Package, since the original class
*   from WooCommerce Correios has a bug in the method get_package_data,
*   which swaps Height with Length and vice-versa. This wrapper fixes this bug.
*/
trait CFPPPackageTrait
{
    /**
     * Order package.
     *
